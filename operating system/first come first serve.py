...
for i in range(len(mylist_2)):
    ...
    sleep(0.5)
print("Idle times and completion times:")

print(mylist_2)
for i in range(len(mylist_2)):
    m=mylist_2[i][4] - mylist_2[i][2]
    mylist_2[i].append(m)
    sleep(0.5)
print(mylist_2)
for i in range(len(mylist_2)):
    m=mylist_2[i][5] - mylist_2[i][3]
    mylist_2[i].append(m)
    sleep(0.5)
print(mylist_2)
print("id\tpriority\tarrival_time\tbrust_time\tcomplition_time\tturnaround_time\twaiting_time")
for i in range(len(mylist_2)):
    sleep(1)
    print(f"{mylist_2[i][0]}                  \t{mylist_2[i][1]}                  \t{mylist_2[i][2]}                   \t{mylist_2[i][3]}                 \t{mylist_2[i][4]}                 \t{mylist_2[i][5]}              \t{mylist_2[i][6]}")
print("Your First Come First Serve Algorithm Is Completed")
'''
from time import sleep
mylist_1=[["p1",3,0,8],["p2",4,1,2],["p3",4,3,4],["p4",5,4,1],["p5",2,5,6],["p6",6,6,5],["p7",7,10,1]]
print("Initial list:")
